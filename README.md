...
2. Ensure that .csv file is in the files of Google Colab so that an error is avoided when running.

3. To make the project faster, please set the runtime to T4 GPU and Python3.

4. Run the program and observe the ouputs.
